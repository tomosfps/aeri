...
export function getUserAvatar(userId: string, hash: string | null): string {
    return hash
...
export function getUserGuildAvatar(
    guildId: string | undefined,
    userId: string,
    hash: string | undefined | null,
): string {
    return `https://cdn.discordapp.com/guilds/${guildId}/users/${userId}/avatars/${hash}.png?size=1024`;
}
