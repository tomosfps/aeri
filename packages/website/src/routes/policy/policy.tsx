      ...
      <section className="space-y-12">
        ...
        <div id="contact" className="bg-cbackground-light border border-cborder-light rounded-xl p-6 shadow-sm">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <a href="https://discord.gg/kKqsaKYUfz" className="bg-[#5865F2]/10 hover:bg-[#5865F2]/20 border border-[#5865F2]/30 text-white rounded-lg p-4 flex items-center transition-colors">
